        ...
        <center>
          ...
          <head>
            ...
            <script type="text/javascript">
              ...
              teamScores = [
                ...
                if ($handle) {
                  while (($line = fgets($handle)) !== false) {
                    ...
                    echo "'";
                    echo file_get_contents("../teams/" . $teamno . "/robotScoresPriv/ip-priv-color.txt");
                    echo ";";
                    echo file_get_contents("../teams/" . $teamno . "/robotScoresPriv/rd-priv-color.txt");
                    echo ";";
                    echo file_get_contents("../teams/" . $teamno . "/robotScoresPriv/cv-priv-color.txt");

                    echo "',";

                    echo "'";
                    $list = glob("../teams/" . $teamno . "/uploads/*IP_VIDEO*");
                    if (!empty($list)) {
                      echo " <b style=\"color:green!important;background-color:transparent!important;\">IP</b>";
                    }
                    $list = glob("../teams/" . $teamno . "/uploads/*CV_VIDEO*");
                    if (!empty($list)) {
                      echo " <b style=\"color:green!important;background-color:transparent!important;\">CV</b>";
                    }
                    $list = glob("../teams/" . $teamno . "/uploads/*RD_VIDEO*");
                    if (!empty($list)) {
                      echo " <b style=\"color:green!important;background-color:transparent!important;\">RD</b>";
                    }
                    $list = glob("../teams/" . $teamno . "/uploads/*RD_DOC*");
                    if (!empty($list)) {
                      echo " <b style=\"color:green!important;background-color:transparent!important;\">RD_DOC</b>";
                    }
                    echo "',";
                    echo "\n";
              ...
              function showNotes(rubric, team) {
        
							// modal.style.display = "block";
							$('#exampleModal').modal('show')
							h = window.innerHeight - 100;
							document.getElementById("exampleModalLabel").innerHTML = "Team No. " + team;
							document.getElementById("modal-content").innerHTML = "<pre>"+textFile("../teams/" +team+ "/robotScoresPriv/"+rubric+"-priv.txt")+"</pre>"
              ...
              function gentable(teamin, n) {
                ...
                document.write('  <td><a target="_blank" href="../teams/' + fwteam + '">' + teamin.split(',')[1] + '</a> '+teamScores[n + 5]+'</td>');
                ...
                if (true) {
                  ...
                  teamscore = teamScores[n + 0]
                  //textFileToArray("../teams/" + fwteam + "/robotScores/rb-rp-s.txt")[0].split(';')[0];
                  // teamscore = "X";
                } else {
                  teamscore = "0";
                }
                //document.write(' <td id="'+fwteam+'-'+c+'"><a href="/scorer/index.html?tourn='+tourn+'&team='+fwteam+'&round='+c+'">'+String(teamscore)+'</a></td>');
                // document.write(' <td id="' + fwteam + '-' + c + '"><button style="background-color:#98c6f7;border-radius:6px;width:100%; height:30px; font-size:20px;margin-top: 3px;margin-bottom: 3px;" onclick="window.parent.location.href = \'project.php?tourn=' + tourn + '&team=' + fwteam + '&round=' + c + '\'">' + String(teamscore) + '</button></td>');
                document.write(' <td id="' + fwteam + '-' + c + '"><a class="btn btn-primary " style="width:100%;font-size:20px; height:38px;-webkit-user-select:auto; user-select:auto;" href ="project.php?tourn=' + tourn + '&team=' + fwteam + '&round=' + c + '">' + String(teamscore) + '</a></td>');

                //                if (fileExists("../teams/" + fwteam + "/robotScores/rb-rd-s.txt") == true) {
                if (true) {
                  // console.log("../teams/" +fwteam+ "/robotScores/" +c+ ".txt")
                  teamscore = teamScores[n + 1]
                  //textFileToArray("../teams/" + fwteam + "/robotScores/rb-rd-s.txt")[0].split(';')[0];
                  // teamscore = "X";
                } else {
                  teamscore = "0";
                }
                //document.write(' <td id="'+fwteam+'-'+c+'"><a href="/scorer/index.html?tourn='+tourn+'&team='+fwteam+'&round='+c+'">'+String(teamscore)+'</a></td>');
                // document.write(' <td id="' + fwteam + '-' + c + '"><button style="background-color:#98c6f7;border-radius:6px;width:100%; height:30px; font-size:20px;margin-top: 3px;margin-bottom: 3px;" onclick="window.parent.location.href = \'robot.php?tourn=' + tourn + '&team=' + fwteam + '&round=' + c + '\'">' + String(teamscore) + '</button></td>');
                document.write(' <td id="' + fwteam + '-' + c + '"><a class="btn btn-primary " style="width:100%;font-size:20px; height:38px;-webkit-user-select:auto; user-select:auto;" href ="robot.php?tourn=' + tourn + '&team=' + fwteam + '&round=' + c + '">' + String(teamscore) + '</a></td>');


                //                if (fileExists("../teams/" + fwteam + "/robotScores/rb-cv-s.txt") == true) {
                if (true) {
                  // console.log("../teams/" +fwteam+ "/robotScores/" +c+ ".txt")
                  teamscore = teamScores[n + 2]
                ...
                //document.write(' <td id="'+fwteam+'-'+c+'"><a href="/scorer/index.html?tourn='+tourn+'&team='+fwteam+'&round='+c+'">'+String(teamscore)+'</a></td>');
                // document.write(' <td id="' + fwteam + '-' + c + '"><button style="background-color:#98c6f7;border-radius:6px;width:100%; height:30px; font-size:20px;margin-top: 3px;margin-bottom: 3px;" onclick="window.parent.location.href = \'corevalues.php?tourn=' + tourn + '&team=' + fwteam + '&round=' + c + '\'">' + String(teamscore) + '</button></td>');
                document.write(' <td id="' + fwteam + '-' + c + '"><a class="btn btn-primary " style="width:100%;font-size:20px; height:38px;-webkit-user-select:auto; user-select:auto;" href ="corevalues.php?tourn=' + tourn + '&team=' + fwteam + '&round=' + c + '">' + String(teamscore) + '</a></td>');

               
                // c++;
                //     }
                document.write('<td style="text-align:center"><text>' + teamScores[n + 4 - 1] + '</text></td>');
                console.log(teamScores[n + 5 - 1])
                document.write(` <td>
                <button onclick="showNotes('ip','`+fwteam+`')" style="background-color:`+teamScores[n + 5 - 1].split(";")[0]+`;">IP</button>
                <button onclick="showNotes('rd','`+fwteam+`')" style="background-color:`+teamScores[n + 5 - 1].split(";")[1]+`;">RD</button>
                <button onclick="showNotes('cv','`+fwteam+`')" style="background-color:`+teamScores[n + 5 - 1].split(";")[2]+`;">CV</button>
                </td>`);
				...
				<!-- style="overflow-x:hidden;overflow-y:hidden;" -->
					<div class="modal-content" >
						...
						<div class="modal-body" >
							<p id='modal-content' style="text-align:left;">Some text in the Modal..</p>
            ...
            <table class="styled-table" border="1" id="my_table">
              <thead>
                <tr style="background-color: lightgrey;text-align:center;">
                  ...
                  <th style="max-width: 80px;"><button style="background-color: transparent;border-color: transparent; width: 100%;word-wrap:break-word;" onclick="sortTable(3)">Innovation Project</button></th>
                  ...
                  <th style="max-width: 80px;"><button style="background-color: transparent;border-color: transparent; width: 100%;word-wrap:break-word;" onclick="sortTable(6)">Gracious Professionalism</button></th>
                  <th style="max-width: 80px;"><button style="background-color: transparent;border-color: transparent; width: 100%;" >Judges Notes</button></th>
