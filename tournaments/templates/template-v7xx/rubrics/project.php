...
if (isset($_POST['teamNo'])) {
    ...
    $filename = "../teams/" . $_POST['teamNo'] . "/robotScores/rb-rp.txt";
    ...
    $filename = "../teams/" . $_POST['teamNo'] . "/robotScores/rb-rp-s.txt";

    $user = fopen($filename, "w")  or die("Failed to save. Please download the backup file by clicking <button onclick='download(\"" . $_POST['bkp'] . "\", \"" . $_POST['fname'] . "\", \"txt\");'>here</button> and try again. You can load the backup file under advanced options.");
    fwrite($user, $_POST['score']);
    fclose($user);

    $filename = "../teams/" . $_POST['teamNo'] . "/robotScoresPriv/ip-priv.txt";
    $user = fopen($filename, "w");
    fwrite($user, $_POST['privnotes']);
    fclose($user);

    $filename = "../teams/" . $_POST['teamNo'] . "/robotScoresPriv/ip-priv-color.txt";
    $user = fopen($filename, "w");
            ...
            <div data-role="tabs">
                ...
                <div id="tabs-1">
                    <form>
                        ...
                        <div id="projectlist" style="max-width: 1024px;overflow-x: auto; ">
                ...
                <div id="tabs-4">
                    ...
                    <div style="max-width:500px">
                        ...
                        <form action="" id="serverForm" method="post">
                            ...
                            <textarea name="privnotes"><?php echo file_get_contents("../teams/" . $_GET['team'] . "/robotScoresPriv/ip-priv.txt"); ?></textarea>
                            <b>Label color:</b>
