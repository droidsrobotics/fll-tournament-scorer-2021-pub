...
if (isset($_POST['teamNo'])) {
    ...
    $filename = "../teams/" . $_POST['teamNo'] . "/robotScores/se" . $_POST['roundNo'] . ".txt";
    ...
    $filename = "../backup/submissions/" . $_POST['fname'];
...
<script>
    function tournamentload() {
        ...
        loadsave(textFileToArray("../teams/" + team + "/robotScores/se" + round + ".txt")[0].split(';')[1])
        loadsave(textFileToArray("../teams/" + team + "/robotScores/se" + round + ".txt")[0].split(';')[1])
...
<div>
  ...
  <div id="header"></div><br>
    ...
    <div style='max-width:500px'>
        <input onclick="window.location.href = '../teams/<?php echo $_GET["team"]; ?>';" type="button" value="Return Home">
    </div>
        ...
        <table style="width:98%; text-align:center; margin-left:auto; margin-right:auto;border:none!important;">
            <tr>
                ...
                <td style="width:50%; font-size:24px; text-align:center">
                    <b id="title">FLL RePlay Scorer</b> (Self-evaluation)
                </td>
                <td style="width:25%; font-size:12px; text-align:right">
                    <img alt="FLL..." style="border:1px solid #021a40;" src="assets/images/FLL.png" height="57"> <img alt="INTO ORBIT..." style="border:1px solid #021a40;" src="assets/images/replay.jpg" height="57"> <img alt="FLL Tutorials" style="border:1px solid #021a40;" src="assets/images/flltutorials.png" width="139"><img class="only-mobile" alt="FLL Tutorials" style="border:1px solid #021a40;" src="assets/images/flltutorials.png" width="139">
                </td>
            </tr>
        </table>
        ...
        <div data-role="tabs">
            ...
            <div id="tabs-1">
                ...
                <div style="max-width:500px">
                    ...
                    <?php
                    if ($_SESSION["role"] != "Referee") {
                        echo '<button onclick="savetoserver();" id="saverTscorer" type="button" >Save Score</button>';
                    }
                    ?>
 ...
 bottom: -10000px;
 left: -100000px;" type="file" accept=".TDRRP" id="fileInput">
...
<script>
    ...
    function savetoserver() {
        ...
        filename = match + "_" + time + "_round-" + round + "_score-" + points + "_" + person + ".TDRRP"
    ...
    function loadScore(save) {
        ...
        if (team != teamC || round != roundC) alert("Incorrect team or round")
            ...
            if (confirm('This file does not appear to have been created by a team; are you sure you want to load it?')) {
                loadsave(load);
                loadsave(load);
