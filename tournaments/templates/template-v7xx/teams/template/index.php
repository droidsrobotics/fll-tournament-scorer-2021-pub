        ...
        <section>
            <div class="text-body" style="font-size: 14px;">
                ...
                <body>
                    ...
                    <form action="" id="myForm" name="frmupload" method="post" enctype="multipart/form-data" style="margin-left:30px">
                        ...
                        if (file_exists("../../admin/release3.txt")) {
                            ...
                            if ($sublink == "None" || $sublink == "") {
                                if (!file_exists("../../admin/useuploader.txt")) {
                                    ...
                                    Link to Robot Game Round 1 Video: <input class="form-control" type="text" id="robot1" name="robot1" value="' . htmlspecialchars($robot1) . '">
                                    <br>


                                    Link to Robot Game Round 2 Video: <input class="form-control" type="text" id="robot2" name="robot2" value="' . htmlspecialchars($robot2) . '">
                                    <br>

                                    Link to Robot Game Round 3 Video: <input class="form-control" type="text" id="robot3" name="robot3" value="' . htmlspecialchars($robot3) . '">
                                    <br>

                                    Link to Other Materials: <textarea class="form-control" type="text" id="other" name="other" >' . htmlspecialchars($other) . '</textarea>
                                    ...
                                    echo '<br><h6>
                                    Upload Judging Videos, Required Materials and Robot Videos (only from prior events) (max 1GB each):</h6>
                                    <input class="form-control" type="file" name="fileToUpload" id="fileToUpload"><br>
                                    <b>Label:</b> <select class="form-control" name="label">
                                    <option value=""></option>
                                    <option value="RD_VIDEO">Robot Design Judging Video</option>
                                    <option value="IP_VIDEO">Innovation Project Judging Video</option>
                                    <option value="CV_VIDEO">Core Values Judging Video</option>
                                    <option value="RG1_OLD_VIDEO">OLD Robot Game Round 1 Video</option>
                                    <option value="RG2_OLD_VIDEO">OLD Robot Game Round 2 Video</option>
                                    <option value="RG3_OLD_VIDEO">OLD Robot Game Round 3 Video</option>
                                    <option value="RD_DOC">Robot Design Document</option>
                                    <option value="OTHER">Other</option>
                                    </select><p>
                                    Note: if your files are larger than 1GB, please use a video transcoder such as <a href="https://handbrake.fr/">Handbrake</a> and/or a PDF Converter/Compressor such as <a href="https://www.adobe.com/acrobat/online/compress-pdf.html">Adobe Acrobat Online</a>. MP4 or PDF format for files is strongly preferred.
                                        </p>';
...
<div id='output_image'></div>
                    ...
                    if (file_exists("../../admin/release3.txt")) {
                        ...
                        //     if (file_exists('code.txt')) echo "<br><br><h4>Robot game code is " . file_get_contents('code.txt') . " <input type='button' onclick='deleteFile(\"code.txt\");' value='Reset'></h4>";
                        //     else echo "<h4>No robot game code generated</h4>";
                        // }
                    }
                    if (file_exists("../../admin/useuploader.txt")) {
                    ...
                    <br>
                    <?php
                    if (is_numeric($_SESSION["role"])) echo "<h3>Self-Evaluate Your Robot Game Performance:</h3>";
                    else echo "<h3>View Self-Evaluated Robot Game Scores:</h3>";
                    ?>
                    <?php
                    $teamno = basename(dirname(__FILE__));
                    if (file_exists("../../admin/release3.txt") || !is_numeric($_SESSION["role"])) {

                        echo "<a href='../../scorer/indexSE.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.virtualopeninvitational.org/images/score-icon.png'>View/Submit Robot Game Round 1 Score</a><br />";
                        echo "<a href='../../scorer/indexSE.php?round=2&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.virtualopeninvitational.org/images/score-icon.png'>View/Submit Robot Game Round 2 Score</a><br />";
                        echo "<a href='../../scorer/indexSE.php?round=3&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.virtualopeninvitational.org/images/score-icon.png'>View/Submit Robot Game Round 3 Score</a><br />";
                    }
                    if ($_SESSION["role"] == "Tournament Director" || $_SESSION["role"] == "Judge" || $_SESSION["role"] == "Referee") {
                        ...
                        echo "<a href='../../rubrics/project.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.virtualopeninvitational.org/images/rubric-icon.png'>Edit Innovation Project Judging Rubric</a><br />";
                    ...
                    if (file_exists("../../admin/release.txt")) {
                        if (file_exists("robotScores/rb-rp.txt")) {
                            echo "<a href='../../rubrics/projectRO.php?round=1&team=" . $teamno . "'><img style='height:50px; margin-left:30px; margin-right:4px; margin-top: 4px; margin-bottom: 4px;' src='http://tournament.virtualopeninvitational.org/images/rubric-icon.png'>View Innovation Project Judging Rubric</a><br />";
                        }
